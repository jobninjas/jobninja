      ...
      <section className="ai-ninja-hero">
        <div className="container">
          <div className="hero-badge-premium">
            ...
            <span>AI Ninja ΓÇô Self-Serve</span>
          </div>
          ...
          <p className="ai-ninja-description">
            {BRAND.name} AI Ninja helps you skip the copyΓÇôpaste chaos. Open a job, click "Apply with AI Ninja", 
            upload your base resume, and get a tailored resume, cover letter, and suggested answers for common 
            application questions. You stay in control of final submission ΓÇô we just give you everything you need, fast.
          </p>
